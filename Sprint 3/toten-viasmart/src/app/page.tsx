      ...
      <Link href={'/Idioma'}>
        <div className="w-full h-screen bg-white flex flex-col justify-center items-center">
          ...
          <div className="w-full mt-3 h-screen flex flex-col md:flex-row space-x-2 z-10">
            <div className="w-full md:w-2/3 h-140 ml-0 md:ml-18 mt-20 flex-col">
              <h2 className="text-5xl md:text-[10rem] font-semibold text-black">
                Busque <span className="text-[#3B48EF]">Novas</span> formas de <span className="text-[#3B48EF]">ir</span>
              </h2>
              <p className="ml-0 md:ml-115 text-2xl md:text-3xl text-black font-light mt-5">Toque para iniciar</p>

              <div className="w-full md:w-300 h-40 flex justify-left items-center mt-10 gap-2">
